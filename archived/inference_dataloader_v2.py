...
class NanoporeDatasetIterator:
    ...
    def _read_df(self):
        ...
        df = df[["kmer_token", "bq_token", "position_token", "signal_token", "move_token", "target_mask",
                 "label_id", "label", "block_id", "motif", "mapq", "flag", "pi", "read_bq", "block_bq", "base_bq", "error",
                 "genome_id"]]
    ...
    def nanopore_row_to_tensor(self, row):
        ...
        metadata_dict = {"motif": motif, "mapq": mapq, "flag": flag, "pi": pi, "read_bq": read_bq,
                            "block_bq": block_bq, "base_bq": base_bq, "error": error}
        ...
        return_dict = {"kmer_token": kmer_token, "bq_token": bq_token, "position_token": position_token,
                       ...
                       "metadata": metadata_dict, "genome_id": genome_id}
...
def pad_collate(batch, pad_to, bq_clip):
    ...
    source["genome_id"] = [item[0]["genome_id"] for item in batch]
