...
from archived.train_eval.dataloader_v5 import load_dataset, NanoporeDataLoader
...
def prepare_dataloader(data_path, batch_size, eval_batch_size, disk_shard_size, rank, num_replicas, buffer_size,
                       read_every, seed, class_ratio, prefetch_factor, pin_memory, soft_label, num_workers):
    ...
    train_loader = load_dataset(train_pos_data_path, train_neg_data_path, batch_size, disk_shard_size, rank, num_replicas,
                                ...
                                prefetch_factor = prefetch_factor, pin_memory = pin_memory, soft_label=soft_label, num_workers = num_workers)
