...
from archived.tokenizer_conv import create_segment_len_arr, expand_token_to_segment, create_move_token, create_target_mask, seq_to_onehot_kmer
...
def segment_normalize_fft_signal(seg_df_path, pid, wdir_path, signal_path_arr, label_df, sampling_ratio = None,
    ...
    for signal_path in tqdm.tqdm(signal_path_arr):
        ...
        signal_df = signal_df[['label_id', 'label', "block_id", "seq_token", "bq_token", "signal_token", "move_token", "target_mask"]].copy()
        gc.collect()
