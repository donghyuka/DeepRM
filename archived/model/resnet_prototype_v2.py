...
class ResNetModel(nn.Module):
    ...
    def __init__(self, n_layers_kmer: int, n_layers_sig: int, n_layers_merged: int, n_layers_final: int,
        ...
        self.residual_module_merged_1 = nn.Sequential(*self.residual_module_merged_1)
        self.residual_module_merged_2 = nn.Sequential(*self.residual_module_merged_2)
        self.residual_module_merged_3 = nn.Sequential(*self.residual_module_merged_3)
        self.residual_module_merged_4 = nn.Sequential(*self.residual_module_merged_4)
