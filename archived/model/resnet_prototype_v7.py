...
class ResNetModel(nn.Module):
    ...
    def __init__(self, n_layers_kmer: int, n_layers_sig: int, n_layers_merged: int, n_layers_final: int,
        ...
        for _ in range(2):
            ...
            self.regression_head_1.append(nn.BatchNorm1d(200))
            self.regression_head_1.append(nn.Dropout(dropout))
        ...
        for _ in range(n_layers_final-2):
            ...
            self.regression_head_2.append(nn.BatchNorm1d(current_dim))
            self.regression_head_2.append(nn.Dropout(dropout))
