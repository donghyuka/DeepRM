...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.kmer_embedding = nn.Embedding(self.kmer_count*(max_bq+1), d_model)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_bq: Tensor, src_move: Tensor,
        ...
        src_bq = src_bq * self.kmer_count
        src_kmer = src_bq + src_kmer
        src_kmer = src_kmer * (src_pad_mask == 0)
