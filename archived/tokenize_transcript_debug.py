...
def segment_normalize_signal(seg_df_path, signal_path_arr, norm_factor, label_df, pid,
    ...
    for signal_path in tqdm.tqdm(signal_path_arr):
        ...
        out_path = f"{seg_df_path}/token_light_v4/{signal_path.split('/')[-1]}"
        ...
        signal_df = signal_df[["label_id", "block_id", "label", "signal", "bq", "motif"]].copy()
    ...
    out_path = f"{seg_df_path}/token_light_v4/last-{pid}.pkl"
...
def main():
    ...
    token_output_path = f"{args.output}/token_light_v4/"
