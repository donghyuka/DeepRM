...
template = "python -m postprocess.train_site --eval_interval 50 --es_patience 5 --es_start 5 --gpu 1 --gpu_pool {} --batch {} --num_err_layers {} --num_output_layers {} --num_meta_layers {} --num_pred_layers {} --weight_decay {} --dropout {} --lr {} --hidden_dim {} --kernel_size {}"
