...
from archived.misc.segment_normalize_signal import preprocess_pod5, segment_signal, segment_spectrogram
...
def expand_row_to_blocks(read_id, signal_seg, signal_fft, seq, bq, boi="A", pad = 10, zfill=6):
    ...
    df = pd.DataFrame({"block_id": block_id_list, "signal_seg": signal_seg_list,
