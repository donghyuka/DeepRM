...
def main():
    ...
    datid_df_s = sample_eval_data(datid_df, non_drach = True, ratio = False)
    datid_df_s.to_csv("/extdata4/baeklab/Hyeonseo/m6A/runs/exp_MRNA/ON0090/ON0090/label/miclip2_glori_m6ace.v2.notsampled.nondrach.tsv", sep='\t', index=False)
