...
def parse_args():
    ...
    parser.add_argument("--smt", dest="spacer_mismatch_tolerance", type=int, default=5)
    parser.add_argument("--smp", dest="spacer_mismatch_penalty", type=int, default=1)
    parser.add_argument("--sst", dest="spacer_size_tolerance", type=int, default=2)
