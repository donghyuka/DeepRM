...
def parse_args():
    ...
    args.add_argument("--output", "-o", type=str, default="/extdata4/baeklab/Hyeonseo/m6A/postprocess/dataset_v12", help="Output path")
...
def main():
    ...
    max_num_positives = label_df[label_df["label"] == 1].shape[0]
