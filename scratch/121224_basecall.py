...
def parse_args():
    ...
    parser.add_argument("--in", "-i", dest = "input", type=str, default = None, help="Input POD5 PATH")
...
def main():
    ...
    model_path = f"/extdata3/baeklab/Hyeonseo/bin/dorado-0.7.3/model/rna004_130bps_sup@v5.0.0"
    ...
    cmd = f"{args.dorado} basecaller --reference {args.ref} --no-trim --modified-bases m6A pseU --chunksize 12000 -x {args.gpu} {args.batch} --min-qscore 0 --emit-moves --estimate-poly-a {model_path} {args.input} > {raw_bam_path}"
