...
def parse_args():
    ...
    parser.add_argument("--pos", "-p", type=str, help="Position column", default="pos")
    parser.add_argument("--strand", "-s", type=str, help="Strand column", default="str")
    parser.add_argument("--pos_offset", "-po", type=int, help="Positive offset", default=0)
    parser.add_argument("--neg_offset", "-no", type=int, help="Negative offset", default=0)
