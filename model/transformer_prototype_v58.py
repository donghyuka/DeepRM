...
class TransformerModel(nn.Module):
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_bq: Tensor, src_pad_mask: Tensor) -> Tensor:
        ...
        final_embedding = torch.stack([kmer_embedding, signal_embedding, bq_embedding], dim = 0).sum(dim = 0)
