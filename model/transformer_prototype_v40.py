...
class TransformerModel(nn.Module):
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_bq: Tensor, src_move: Tensor,
        ...
        cross_output = self.cross_attention_layer(signal_output, kmer_embedding, kmer_embedding, key_padding_mask = src_pad_mask,
                                                  need_weights = False, is_causal = False)
        cross_output = cross_output[0] + signal_output
        cross_output = self.layer_norm(cross_output)
        cross_output = self.transformer_encoder_2(src=cross_output, mask = None, src_key_padding_mask = src_pad_mask)
