...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
                 ...
                 kmer_size: int = 5, signal_size: int = 25, spectrogram_size: int = 21, max_bq: int = 50, block_len = 17,
        ...
        self.joint_embedding = nn.Linear(4 * d_model, d_model)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_seg_len: Tensor, src_dwell_bq: Tensor) -> Tensor:
        ...
        src_dwell = src_dwell_bq[:,:,:2]
        src_bq = src_dwell_bq[:,:,2:] / self.max_bq
        ...
        joint_embedding = torch.cat([signal_embedding, kmer_embedding, dwell_embedding, bq_embedding], dim = -1)
