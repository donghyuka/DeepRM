...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.regression_head = RegressionHead(d_model,d_model, lin_act, lin_depth, lin_dropout, seq_len)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_move: Tensor, src_pad_mask: Tensor, target_mask: Tensor) -> Tensor:
        ...
        signal_output = torch.add(signal_output, kmer_embedding)
