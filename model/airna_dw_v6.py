...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.bq_dwell_embedding = nn.Linear(3, d_model)
    ...
    def init_weights(self, initrange = 0.1):
        ...
        self.bq_dwell_embedding.weight.data.uniform_(-initrange, initrange)
        return None
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_seg_len: Tensor, src_dwell_bq: Tensor) -> Tensor:
        ...
        output = self.transformer_decoder(tgt=self.kmer_embedding(src_kmer) + self.bq_dwell_embedding(src_dwell_bq) + self.pos_encoding_2(src_kmer.size(0)) ,
