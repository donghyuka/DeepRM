...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.kmer_embedding = nn.Embedding(self.kmer_count*block_len, d_model)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_bq: Tensor, src_move: Tensor,
        ...
        src_kmer = src_kmer + (src_move-1) * self.kmer_count
        ...
        final_embedding = torch.stack([kmer_embedding, signal_embedding], dim = 0).sum(dim = 0)
