...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.dwell_embedding = nn.Linear(2 + d_model, d_model)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_seg_len: Tensor, src_dwell_bq: Tensor) -> Tensor:
        ...
        kmer_embedding = self.dwell_embedding(torch.cat([src_dwell_bq, kmer_embedding], dim = -1))
        ...
        final_embedding = signal_embedding + kmer_embedding + pos_encoding
