...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.transformer_encoder_1 = TransformerEncoderWithWeight(encoder_layer, n_layers)
        self.transformer_encoder_2 = TransformerEncoderWithWeight(encoder_layer, 2)
        self.transformer_encoder_3 = TransformerEncoderWithWeight(encoder_layer, 2)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_move: Tensor,
        ...
        attn_list_list.extend(attn_list)
        cross_output, attn = self.cross_attention_layer(kmer_output, signal_output, signal_output, key_padding_mask = src_pad_mask,
