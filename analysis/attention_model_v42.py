...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.transformer_encoder_2 = TransformerEncoderWithWeight(encoder_layer, 1)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor,
        ...
        attn_list_list.extend(attn_list)
        cross_output = torch.add(signal_output, kmer_output)
