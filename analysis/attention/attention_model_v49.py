...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, d_ff: int,
        ...
        self.kmer_embedding = nn.Embedding(4*block_len+1, d_model)
    ...
    def forward(self, src_kmer: Tensor, src_signal: Tensor, src_bq: Tensor, src_move: Tensor,
        ...
        src_kmer = ((src_kmer-1)%64)//16
        src_move = (src_move-1)*4
        src_kmer = src_kmer + src_move + 1
        src_kmer = src_kmer * src_pad_mask.logical_not()
        ...
        final_embedding = torch.add(kmer_embedding, signal_embedding)
        ...
        target_mask_sum = torch.clamp(target_mask_sum, min = 1)
