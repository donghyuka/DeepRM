...
def find_block_candidates(seq, phred, cb_bq_cutoff, spacer_kmer_ed_dict, skip_size_tolerance, cb_pad,
    ...
    for from_spacer_idx in range(len(spacer_list)):
        ...
        if (from_spacer_idx+1) % (cb_per_bb + 1) == 0:
            cb_idx = None
            single_anchor = None
        else:
            cb_idx = (from_spacer_idx // (cb_per_bb+1)) * cb_per_bb + (from_spacer_idx % (cb_per_bb+1))
            single_anchor = anchor_list[cb_idx]


        from_spacer_kmer_ed_dict = spacer_kmer_ed_dict[from_spacer_idx]

        for to_spacer_idx in range(from_spacer_idx+1, len(spacer_list)):
            ...
            for from_kmer, to_kmer, kmer_edit in kmer_tuple_list:
                for from_pos, to_pos in it.product(kmer_pos_dict[from_kmer], kmer_pos_dict[to_kmer]):
                    ...
                    ideal_displacement, small_steps, big_steps = get_ideal_displacement(from_spacer_idx % (cb_per_bb+1),
                                                                                        to_spacer_idx % (cb_per_bb+1),
                                                                                        displacement,
                                                                                        min_ideal_displacement_dict,
                                                                                        cb_per_bb, bb_size,
...
def parse_args():
    ...
    parser.add_argument("--cst", dest="cb_size_tolerance", type=int, default=2)
    ...
    parser.add_argument("--smt", dest="spacer_edit_tolerance", type=int, default=2)
    parser.add_argument("--smp", dest="spacer_edit_penalty", type=int, default=1)
    # parser.add_argument("--ac", dest="anchor_list", type=str, nargs="+", default=["A", "A",
    #                                                                               "G", "A",
    #                                                                               "U", "A",
    #                                                                               "G", "G",
    #                                                                               "U", "A",
    ...
    #                     default=["CGACAU","CCAUUG","AAGCGU",
    #                              "UUCCGG","CGACAU","CCAUUG",
    #                              "CAGACU","ACACAU","CGACAU",
    #                              "CCCCAG","GCAGCU","AGGCUA",
    #                              "GCGAAC","CCTTCA","GCTCTG",])
    ...
    #                              "CCCCAG","GCAGCU","AGGCUA",
    #                              "GCGAAC","CCTTCA","GCTCTG",
    #                              "CAAGAA","GCTTAG","GTGGAC",
    #                              "ACCCAT","GCCGAC","TGTGAC",
    #                     ])
    # parser.add_argument("--ac", dest="anchor_list", type=str, nargs="+", default=["G", "A",
    #                                                                               "G", "G",
    #                                                                               "C", "U",
    #                                                                               "U", "C",
    #                                                                               "G", "U",
    #                                                                               ])
    # parser.add_argument("--sp", dest="spacer_list", type=str, nargs="+",
    #                     default=["CGACAUGA","AUUGUGAU","GUUUCCGG",
    #                              "AAGAACCU","UCCGAUGG","CUGUGCAC",
    #                              "CCUUUGGU","GGCCAGAG","ACUGCUGU",
    #                              "CCUCCAUU","GAAGCGUA","UAGUCCGA",
    #                              "CAUCCTTC","GGCTCTGC","AGCTGGCT",])
    ...
    parser.add_argument("--sp", dest="spacer_list", type=str, nargs="+",
                        default=[
                            "AAGAACCUGC","CGAUGGAACA","GCACCCUUUG",
                            "GUUAAGCGUA","UAGUCCGACA","UCCAUUGGCA",
                            "GCUUCUUAUU","CGAACGUCGA","AGGCCAGTGT",
                            "GAGCCTCCAU","TAAAGCGUCA","AGUCCGACAU",
                            "GTGGACACCC","GAGCCGACAG","TGACTGAGGC",
                        ])



    parser.add_argument("--ss", dest="spacer_size", type=int, default=10)
    parser.add_argument("--cp", dest="cb_pad", type=int, default=10)
    parser.add_argument("--cb", dest="cb_per_bb", type=int, default=2)
