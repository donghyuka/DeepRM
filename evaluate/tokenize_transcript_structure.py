...
def segment_normalize_signal(seg_df_path, signal_path_arr, norm_factor, label_df, pid, norm_mode, token_output_path,
                             cb_len = 21, kmer_len = 5, chunk_size = 10000, max_token_len = 200, sampling = 6, boi = "A", structure_pad = 50):
    ...
    for signal_path in tqdm.tqdm(signal_path_arr):
        ...
        signal_df = signal_df[["label_id", "block_id", "signal", "bq", "motif", "structure_token"]].copy()
...
def main():
    ...
    token_output_path = f"{args.output}/token_structure_{args.norm_mode}_{args.postfix}/"
